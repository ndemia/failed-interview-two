export const soundsOn = new Audio('./assets/sounds/on.mp3');
export const soundsOff = new Audio('./assets/sounds/off.mp3');
export const coins = new Audio('./assets/sounds/coins.mp3');
export const drawerOpen = new Audio('./assets/sounds/drawer_open.mp3');
export const drawerClose = new Audio('./assets/sounds/drawer_close.mp3');
export const resetQuantities = new Audio('./assets/sounds/reset.mp3');
export const increase = new Audio('./assets/sounds/increase.mp3');
export const decrease = new Audio('./assets/sounds/decrease.mp3');
