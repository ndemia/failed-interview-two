...
const showCurrentStock = () => {
    currentStock.forEach(item => {
        container.insertAdjacentHTML('beforeend', `<li class="dashboard__item">
        ...
        productsList.insertAdjacentHTML('beforeend', `<li class="products__item">
